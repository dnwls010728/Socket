...
struct MovePlayerPacket : public Net::IPacket
{
    ...
    SERIALIZABLE_FIELDS(unique_id, position_x, position_y, velocity_x, velocity_y, is_flipped, animation, server_time)
...
struct ObjectPositionPacket : public Net::IPacket
{
    ...
    SERIALIZABLE_FIELDS(object_id, position_x, position_y, velocity_x, velocity_y, is_flipped, animation, server_time)
