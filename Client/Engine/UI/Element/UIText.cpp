...
void UIText::Render()
{
    ...
    // Renderer::Get()->DrawStringWithOutline(text_, GetAbsolutePosition(), GetSize(), Math::Color::Black, color_, 1.f, font_name_, font_size_, text_alignment_, paragraph_alignment_);
}
