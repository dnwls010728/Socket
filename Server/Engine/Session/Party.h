...
public:
    ...
    void SendPacket(const Net::IPacket& packet, uint32_t exclusion_player = 0);
    
    bool Contains(uint32_t player_id) const;
    ...
    inline void SetHost(uint32_t player_id) {  host_id_ = player_id; }
